...
class COCOeval:
            ...
            for obj in objs:
                ...
                if type(obj['segmentation']) == list:
                    if type(obj['segmentation'][0]) == dict:
                        print ('debug')
                    obj['segmentation'] = _mask.frPyObjects(obj['segmentation'],t['height'],t['width'])
                    if len(obj['segmentation']) == 1:
                        ...
                        obj['segmentation'] = _mask.merge(obj['segmentation'])
                elif type(obj['segmentation']) == dict and type(obj['segmentation']['counts']) == list:
                    obj['segmentation'] = _mask.frPyObjects([obj['segmentation']],t['height'],t['width'])[0]
    ...
    def evaluateImg(self, imgId, catId, aRng, maxDet):
        ...
        gtind = [ind for ind_g in sorted(enumerate(gt), key=lambda ind_g: g['_ignore']) ]
